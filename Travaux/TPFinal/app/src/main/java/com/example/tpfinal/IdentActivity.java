...
public class IdentActivity extends AppCompatActivity {
    ...
    private static final String CLIENT_ID = "f049554645a84628a2120ca163173031";
    private static final String REDIRECT_URI = "com.example.tpfinal://callback";
  ...
  private static final String SCOPES = "user-read-recently-played";
    ...
    private void startMainActivity() {
        Intent newintent = new Intent(IdentActivity.this, QuizActivity.class);
